...
func NewBindActiveSetting(typ *MetadataClass, typeMap *TypeMap) *BindActiveSetting {
	...
	for i := 0; i < len(typ.Fields); i++ {
		...
		case "id":
			if typ.Fields[i].Equals(&Field{Name: "id", Type: typeMap.T_LONG, ConstantPool: false, Array: false}) {
...
func (this *ActiveSetting) Parse(data []byte, bind *BindActiveSetting, typeMap *TypeMap) (pos int, err error) {
	var (
		v64_  uint64
		v32_  uint32
		v16_  uint16
