...
func NewBindLogLevel(typ *MetadataClass, typeMap *TypeMap) *BindLogLevel {
...
func (this *LogLevelList) Parse(data []byte, bind *BindLogLevel, typeMap *TypeMap) (pos int, err error) {
	var (
		v64_  uint64
		v32_  uint32
		v16_  uint16
